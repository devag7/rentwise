...
function Home() {
  document.title = 'RentWise - Premium Rentals in Bangalore';
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans selection:bg-blue-200">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/properties" className="inline-flex justify-center items-center px-8 py-4 text-lg font-semibold rounded-full bg-white text-gray-900 hover:bg-gray-100 hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)]">
                Explore Properties
              </Link>
              <Link to="/register" className="inline-flex justify-center items-center px-8 py-4 text-lg font-semibold rounded-full bg-white/10 text-white border border-white/20 hover:bg-white/20 transition-all duration-300 backdrop-blur-md">
                List as Landlord
              </Link>
            </div>
          </div>
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <Link to="/register" className="inline-flex justify-center items-center px-10 py-4 text-lg font-bold rounded-full bg-blue-600 text-white hover:bg-blue-700 hover:shadow-[0_10px_40px_-10px_rgba(37,99,235,0.7)] hover:-translate-y-1 transition-all duration-300">
